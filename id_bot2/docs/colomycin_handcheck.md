# Colomycin/colistin — Clinical Hand-Check Sheet

**Protocol ID:** `colomycin`
...
`colomycin`, `colistin`, `colistimethate`, `colomycin dose`, `colistin dose`
...
|------|------|------|-------|
| LOADING *(always_show)* | 9 million IU once | start of therapy, then start maintenance 12 h later | — |
| NORMAL | 3 x 3 million IU | GFR >=50 | — |
| GFR_30_TO_50 | 3 x 2 million IU | GFR 30-50 | — |
| GFR_LT_10 | 3 x 1 million IU | GFR <10 | — |
| IHD | dialysis days: maintenance 3 x 1 million IU + 3 million IU extra post-dialysis; non-dialysis days: 3 x 1 million IU | IHD | — |
| CRRT | 3 x 3 million IU | CRRT | — |
...
## 4. Selection ladder
  ...
  4. `if gfr >= 30 and gfr < 50` → tier `GFR_30_TO_50`
  5. `if gfr < 10` → tier `GFR_LT_10`
