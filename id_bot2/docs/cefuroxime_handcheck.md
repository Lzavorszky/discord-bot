# Cefuroxime — Clinical Hand-Check Sheet
...
`cefuroxime`, `cefuroxim`, `cefuroxime dose`, `cefuroxime dosing`
...
|------|------|------|-------|
| LOADING *(always_show)* | 1.5 g once | start of therapy; then continue scheduled dosing | — |
| NORMAL | 4 x 1.5 g | GFR >20 | — |
| GFR_10_TO_20 | 2 x 1.5 g | GFR 10-20 | — |
| GFR_LT_10 | 1 x 1.5 g | GFR <10 | — |
| IHD | 1 x 1.5 g | IHD | — |
| CRRT | 2 x 1.5 g | CRRT | — |
...
## 4. Selection ladder
  ...
  4. `if gfr >= 10 and gfr <= 20` → tier `GFR_10_TO_20`
