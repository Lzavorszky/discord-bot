# Tigecycline — Clinical Hand-Check Sheet
...
|------|------|------|-------|
| LOADING *(always_show)* | 200 mg once | start of therapy, then start maintenance 12 h later | — |
| NORMAL | 2 x 100 mg | all renal/RRT tiers | — |
