...
`cefiderocol`, `cefiderocol dose`, `cefiderocol dosing`, `cefiderocol iv`, `fdc`
...
| NORMAL | 6 g/day | GFR 30-90 | 2 g/50 mL, 6.3 mL/h |
| SEVERE_AKI | 3 g/day | GFR <30 | 2 g/50 mL, 3.1 mL/h |
| ANURIA_IHD | 1.5 g/day | anuria or IHD | 1 g/50 mL, 3.1 mL/h |
| CRRT | 6 g/day | CRRT | 2 g/50 mL, 6.3 mL/h |

**Verify each row against source `uploaded antibiotic renal dosing DOCX - cefiderocol`:**
...
## 4. Selection ladder
  ...
  2. `if crrt` → tier `CRRT`
  3. `if gfr >= 30 and gfr <= 90` → tier `NORMAL`
  4. `if gfr < 30` → tier `SEVERE_AKI`
