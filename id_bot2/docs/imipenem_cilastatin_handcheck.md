# Imipenem/cilastatin — Clinical Hand-Check Sheet

**Protocol ID:** `imipenem_cilastatin`
...
`imipenem/cilastatin`, `imipenem cilastatin`, `imipenem`, `imipenem dose`
...
|------|------|------|-------|
| LOADING *(always_show)* | 1 g once | start of therapy, then continue scheduled dosing | — |
| NORMAL | 4 x 1 g | GFR >=90 | — |
| GFR_60_TO_90 | 3 x 1 g | GFR 60-90 | — |
| GFR_30_TO_60 | 4 x 500 mg | GFR 30-60 | — |
| GFR_15_TO_30 | 2 x 500 mg | GFR 15-30 | — |
| IHD | 1 x 1 g | IHD | — |
| CRRT | 4 x 1 g | CRRT | — |
...
**Footer:** 1 g = imipenem/cilastatin 500/500 mg. GFR <15 (non-IHD): no defined tier — provide full table and confirm dose. Use only the dose tiers listed in this protocol.
