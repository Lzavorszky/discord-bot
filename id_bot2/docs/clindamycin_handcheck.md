# Clindamycin — Clinical Hand-Check Sheet

**Protocol ID:** `clindamycin`
...
`clindamycin`, `clinda`, `clindamycin dose`, `clindamycin dosing`
...
|------|------|------|-------|
| NORMAL | 3 x 900 mg | all renal/RRT tiers | — |
