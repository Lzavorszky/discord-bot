# Moxifloxacin — Clinical Hand-Check Sheet

**Protocol ID:** `moxifloxacin`
...
`moxifloxacin`, `moxi`, `moxifloxacin dose`, `moxifloxacin dosing`
...
|------|------|------|-------|
| NORMAL | 1 x 400 mg | all renal/RRT tiers | — |
