...
`ceftazidime`, `ceftazidim`, `ceftazidime dose`, `ceftazidim dose`, `ceftaz`
...
| STEP_UP | 8 g/day | low levels | 2 g/50 mL, 8.4 mL/h |

**Verify each row against source `uploaded antibiotic renal dosing DOCX - ceftazidim`:**
