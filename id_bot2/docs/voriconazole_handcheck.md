...
`voriconazole`, `voriconazol`, `vori`, `voriconazole dose`
...
|------|------|------|-------|
| LOADING *(always_show)* | 2 x 6 mg/kg | first 24 h, then start maintenance | — |
| NORMAL | 2 x 4 mg/kg | all renal/RRT tiers | — |
